#Credit to Matthew Inkawhich for Tutorial
	...
	with open(fileName, 'r', encoding = 'iso-8859-1') as f:
		for line in f:
			...
			for lineId in lineIds:
				comvObj["lines"].appends(lines[lineId])
...
def evaluate(encoder, decoder, searcher, voc, sentence, max_length=MAX_LENGTH):, sentence)]
    lengths = torch.tensor([len(indexes) for indexes in indexes_batch])
